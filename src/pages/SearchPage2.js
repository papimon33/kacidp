		...
		<div className="container">
			<div className="search-box">
				...
				<div className="search-brief-card">
					2024년 6월 20일 <span style={{color:"#18427c", fontWeight:'bold'}}>김포공항 출발 여객 수</span>는 <span style={{color:"#18427c", fontWeight:'bold'}}>1,000명</span>입니다.
				</div>
				...
				<div className=' my-3 border-bottom'>
					...
					<SearchResultItem icon="email-color" caption="내부메일" title="(보낸 메일) 주간일정 취합요청(~6.20)" description="박현우 / `24.6.19 / 안녕하세요? 주간일정을 보내주시기 바랍니다....." />
					<SearchResultItem icon="email-color" caption="내부메일" title="(받은 메일) 투자사업 상반기 집행전망 점검 및 제출" description="(보낸사람) 김민섭, (날짜) `24.6.18, (내용) 데이터융합부 투자사업 상반기 집행현황을 제출..." />
				</div>
				<div className=' my-3 border-bottom'>
				...
				<div className="fixed-grid has-3-cols">
					...
					<table className="table is-fullwidth">
						<tbody>
							...
							<tr>
								<th>내용</th>
								<td>1. 감사실-111 "2024년도 감사 착안사항 심사 계획"<br/><br/>2. 위 관련 감사 착안사항 심사결과를 다음과 같이..</td>
							</tr>
						</tbody>
					</table>
				</div>
